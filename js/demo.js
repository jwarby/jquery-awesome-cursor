$(window).load(function() {
  ...
  // Append copy to clipboard button next to all code samples
  $('.highlight pre').each(function(i, block) {
    var $block = $(block);

    $block.prepend($('<button />', {
      class: 'btn btn-primary btn-xs pull-right copy-to-clipboard',
      html: '<i class="fa fa-arrow-right"></i><i class="fa fa-clipboard"></i>',
      title: 'Copy to clipboard',
      'data-clipboard-text': $block.text()
    }));
  });
